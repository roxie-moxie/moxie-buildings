...
# noqa: F401 — registers all models on Base.metadata for autogenerate
from moxie.db.models import Base  # noqa: F401
...
config.set_main_option(
    "sqlalchemy.url", os.environ.get("DATABASE_URL", "sqlite:///./moxie.db")
)
